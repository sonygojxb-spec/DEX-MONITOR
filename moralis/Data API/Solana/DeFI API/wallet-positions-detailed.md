...
````yaml /openapi-files/data-api/api-v1.json GET /v1/wallets/{walletAddress}/defi/{protocol}/positions
openapi: 3.0.0
info:
...
paths:
  /v1/wallets/{walletAddress}/defi/{protocol}/positions:
    get:
      tags:
        - DeFi
      summary: Get DeFi positions for a specific protocol
      description: >-
        Returns DeFi positions for a wallet address filtered by a specific
        protocol across specified chains.
      operationId: getDefiProtocolPositions
      parameters:
        - name: walletAddress
          required: true
          in: path
        ...
        - name: protocol
          required: true
          in: path
          description: Protocol identifier (e.g. "aave-v3", "uniswap-v3")
          schema:
            example: aave-v3
            type: string
        - name: chains
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/UniversalDefiProtocolPositionsResponseDto'
      security:
        - ApiKeyAuth: []
components:
  schemas:
    UniversalDefiProtocolPositionsResponseDto:
      type: object
      properties:
        meta:
        ...
        result:
          nullable: true
          allOf:
            - $ref: '#/components/schemas/UniversalDefiProtocolDto'
        cursor:
          type: string
